...
def TakeStereo(id, t0stereo, frame):
    ...
    cal_disparity= ((cal_disparity.astype(np.float32)/ 16)-min_disp)/num_disp
    Depth_buffer = 7*10**8*np.power(np.float16(cal_disparity),-2.4)
